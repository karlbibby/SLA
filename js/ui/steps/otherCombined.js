...
function renderOtherCombinedStep(character, container, onUpdate) {
    ...
    const duplicateEquipmentTypes = getDuplicateEquipmentTypes(equipmentItems);
    normalizeEquipmentInventory(character, equipmentItems);
    ...
    equipmentItems.forEach((item, index) => {
        const key = getEquipmentKey(item, index, duplicateEquipmentTypes);
