...
function renderTrainingStep(character, container, onUpdate) {
    ...
    packagesHtml += '</div>';
    container.innerHTML = `<div class="section-header"><h2 class="section-title">Step 7: Training Packages</h2><p class="section-description">Select pre-built training packages representing your character's background training.</p></div>${packagesHtml}<div class="info-box" style="margin-top:20px"><h4>Training Points</h4><p>Each training package costs points but provides multiple skills at once.</p></div>`;
